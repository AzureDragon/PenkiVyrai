...
public class PieChartEngine extends JFreeChartEngine {
	...
	public boolean prepareJFreeChart(JFreeChart jfchart, Chart chart) {
		...
		Paint[] colors = new Paint[] {ChartColors.COLOR_1, ChartColors.COLOR_2, ChartColors.COLOR_3, ChartColors.COLOR_4, ChartColors.COLOR_5};
		...
		piePlot.setExplodePercent("Išspręstų kreipinių skaičius", explode ? 0.3 : 0);
		piePlot.setExplodePercent("Užregistruotų kreipinių skaičius", explode ? 0.2 : 0);
		piePlot.setExplodePercent("Atsisakytų spręsti kreipinių skaičius", explode ? 0.2 : 0);
		piePlot.setExplodePercent("Grąžintų neišspręsti kreipinių skaičius", explode ? 0.1 : 0);
